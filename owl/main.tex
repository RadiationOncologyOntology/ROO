...
\begin{itemize}
	\item \textbf{IRI}: http://ncicb.nci.nih.gov/xml/owl/EVS/Thesaurus.owl\#C67505
	\item \textbf{Defined By}: http://purl.bioontology.org/ontology/NCIT
	\item \textbf{label}: Angle
	\item \textbf{Definition}: The inclination of one line to another or the plane of one object to another.
\end{itemize}
...
\begin{itemize}
	\item \textbf{IRI}: http://ncicb.nci.nih.gov/xml/owl/EVS/Thesaurus.owl\#C69299
	\item \textbf{Defined By}: http://purl.bioontology.org/ontology/NCIT
	\item \textbf{label}: Static
	\item \textbf{Definition}: A term used to denote that something is unchanging, not dynamic.
\end{itemize}
...
\begin{itemize}
	\item \textbf{IRI}: http://purl.bioontology.org/ontology/SNOMEDCT/229027002
	\item \textbf{Defined By}: http://purl.bioontology.org/ontology/SNOMEDCT
	\item \textbf{label}: Dynamic
\end{itemize}

  \subsection{Laboratory Test Time}

\begin{itemize}
	\item \textbf{IRI}: http://ncicb.nci.nih.gov/xml/owl/EVS/Thesaurus.owl\#C83152
	\item \textbf{Defined By}: http://purl.bioontology.org/ontology/NCIT
	\item \textbf{label}: Laboratory Test Time
	\item \textbf{Definition}: The time that the laboratory test was carried out.
\end{itemize}


  \subsection{Length of external beam radiation therapy beam}

\begin{itemize}
	\item \textbf{IRI}: http://purl.bioontology.org/ontology/SNOMEDCT/228802002
	\item \textbf{Defined By}: http://purl.bioontology.org/ontology/SNOMEDCT
	\item \textbf{label}: Length of external beam radiation therapy beam
\end{itemize}
...
\begin{itemize}
	\item \textbf{IRI}: http://ncicb.nci.nih.gov/xml/owl/EVS/Thesaurus.owl\#C88112
	\item \textbf{Defined By}: http://purl.bioontology.org/ontology/NCIT
	\item \textbf{label}: Photon
	\item \textbf{Definition}: A single unit of electromagnetic radiation, generally considered to be a discrete particle having no mass or charge.
\end{itemize}
...
\begin{itemize}
	\item \textbf{IRI}: http://ncicb.nci.nih.gov/xml/owl/EVS/Thesaurus.owl\#C17024
	\item \textbf{Defined By}: http://purl.bioontology.org/ontology/NCIT
	\item \textbf{label}: Proton
	\item \textbf{Definition}: A fundamental particle with a positive charge.
\end{itemize}

  \subsection{Ion}

\begin{itemize}
	\item \textbf{IRI}: http://ncicb.nci.nih.gov/xml/owl/EVS/Thesaurus.owl\#C597
	\item \textbf{Defined By}: http://purl.bioontology.org/ontology/NCIT
	\item \textbf{label}: Ion
	\item \textbf{Definition}: An atom or molecule having a positive or negative charge owing to the loss or gain of one or more electrons.
\end{itemize}
...
\begin{itemize}
	\item \textbf{IRI}: http://ncicb.nci.nih.gov/xml/owl/EVS/Thesaurus.owl\#C45306
	\item \textbf{Defined By}: http://purl.bioontology.org/ontology/NCIT
	\item \textbf{label}: Substance
	\item \textbf{Definition}: Any matter of defined composition that has discrete existence, whose origin may be biological, mineral or chemical.
\end{itemize}
